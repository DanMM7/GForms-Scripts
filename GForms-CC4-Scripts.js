...
setTimeout(function () {
 ...
 setTimeout(function() {
    let adequacySelect = document.querySelector('#FORM_CC4_StabilityDesignAdequacy');
    let adequacyValue = adequacySelect.options[adequacySelect.selectedIndex].value;
    let effectiveSelect = document.querySelector('#FORM_CC4_StabilityOperatingEffect');
    let effectiveValue = effectiveSelect.options[effectiveSelect.selectedIndex].value;
    let ratingOptions = document.querySelectorAll('#FORM_CC4_StabilityCtrlRating option');
